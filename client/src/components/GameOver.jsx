...
const calculatePersonality = (stats) => {
  ...
  if (scaledConscientiousness >= 4.0) {
  ...
  } else if (scaledConscientiousness >= 2.0) {
  ...
  } else if (scaledExtraversion >= 2.0) {
  ...
  if (personalityTraits.length === 0.0) {
